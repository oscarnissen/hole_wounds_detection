...
class KalmanFilter(object):
    ...
    -- modification to 10-dimentional state space
    ...
    def initiate(self, measurement):
        ...
        measurement : ndarray
            ...
            aspect ratio a, height h and depth z.
    ...
    def predict(self, mean, covariance):
        ...
        #print("in predict self._motion_mat: ", self._motion_mat)
        #print("in predict motion_cov: ", motion_cov)
    ...
    def project(self, mean, covariance):
        ...
        #print("in project innovation_cov: ", innovation_cov)
    ...
    def update(self, mean, covariance, measurement):
        ...
        measurement : ndarray
            ...
            is the center position, a the aspect ratio, h the height, and z the depth of the
            bounding box.
    ...
    def gating_distance(self, mean, covariance, measurements,
        ...
        measurements : ndarray
            ...
            format (x, y, a, h, z) where (x, y) is the bounding box center
            position, a the aspect ratio, h the height and z the depth.
